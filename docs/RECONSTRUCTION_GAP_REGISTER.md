...
| SKYNJA-GAP-003 Semantisk forfatterskjema | PARTIAL_CONTRACT | Øvelsesrommet har felles semantiske ID-er og eksplisitte BM/NN-realiseringer for 56 runder. Lesbar gjennomgang og versjonsbundet eksport med 26 tomme reviewoppføringer er implementert. Lokale arbeidsnotater har versjonsbundet eksport, kontrollert gjenåpning og beskyttelse ved appoppdatering. Innholdsredigering, verifisert reviewmottak/promotering og migrering av de ti verkstedpakkene gjenstår. |
...
| SKYNJA-GAP-005 Verifikasjon i dagens miljø | OPEN | Egen teknisk appkontroll og GitHub-jobb tester installérbart bygg, alle 112 målformsrunder, revieweksport, notatflyt og offline. Visuell kontroll dekker mobilbredde, lys/mørk modus, faktiske animasjoner og redusert bevegelse. Full Windows-releasekontroll stopper på manglende autentisk T-objekt for historisk T→U-proof. Fysisk enhet og manuell AT-review gjenstår; se [pilotforberedelse](SKYNJA_PILOT_PREPARATION.md). |
