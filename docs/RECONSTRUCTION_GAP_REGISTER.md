...
| SKYNJA-GAP-005 Verifikasjon i dagens miljø | OPEN | Egen teknisk appkontroll og GitHub-jobb tester installérbart bygg, alle 112 målformsrunder, revieweksport og offline. Full Windows-releasekontroll stopper på manglende autentisk T-objekt for historisk T→U-proof. Fysisk enhet og manuell AT-review gjenstår; se [pilotforberedelse](SKYNJA_PILOT_PREPARATION.md). |
